...
### 📨 Request Example
```http
GET https://free-ff-api-src.onrender.com/api/v1/account?region=IND&uid=1633864660
```
...
### 📨 Request Example
```http
GET https://free-ff-api-src.onrender.com/api/v1/craftlandProfile?region=IND&uid=1633864660
```
### 💬 Response Example
...
### 📨 Request Example
```http
GET https://free-ff-api-src.onrender.com/api/v1/craftlandInfo?region=IND&map_code=2D1AA949DD77714ABB1FA0CE3ECCAFB34660
```
...
### 📨 Request Example
```http
GET https://free-ff-api-src.onrender.com/api/v1/playerstats?region=IND&uid=1633864660
```
### 💬 Response Example
```json
{
...
### 📨 Request Example
```http
GET https://free-ff-api-src.onrender.com/api/v1/wishlistitems?region=IND&uid=1187946149
```
### 💬 Response Example
```json
{
...
### 📨 Request Example
```http
GET https://free-ff-api-src.onrender.com/api/v1/guildInfo?region=IND&guildID=3033195648
```
### 💬 Response Example
```json
{
